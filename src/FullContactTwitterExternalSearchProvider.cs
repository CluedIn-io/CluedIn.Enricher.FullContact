...
namespace CluedIn.ExternalSearch.Providers.Fullcontact
{
    ...
    public class FullContactTwitterExternalSearchProvider : ExternalSearchProviderBase
    {
        /**********************************************************************************************************
         * CONSTRUCTORS
         **********************************************************************************************************/
        ...
        /// </summary>
        public FullContactTwitterExternalSearchProvider()
            : base(Constants.ExternalSearchProviders.FullContactTwitterId, EntityType.Person, EntityType.Infrastructure.User, EntityType.Infrastructure.Contact)
        {
        }
        ...
        public override IEnumerable<IExternalSearchQuery> BuildQueries(ExecutionContext context, IExternalSearchRequest request)
        {
            ...
            var twitter = request.QueryParameters.GetValue(CluedIn.Core.Data.Vocabularies.Vocabularies.CluedInUser.SocialTwitter, null);

            if (twitter != null)
            {
                var values = twitter.SelectMany(v => v.Split(new[] { ",", ";", "|" }, StringSplitOptions.RemoveEmptyEntries)).ToHashSet();
        ...
        public override IEnumerable<IExternalSearchQueryResult> ExecuteSearch(ExecutionContext context, IExternalSearchQuery query)
        {
            ...
            var request = new RestRequest(string.Format("/v2/person.json?twitter={0}", name), Method.GET);
        ...
        private void PopulateMetadata(IEntityMetadata metadata, IExternalSearchQueryResult<Person> resultItem)
        {
            ...
            if (resultItem.Data.contactInfo != null)
            {
                ...
                if (resultItem.Data.contactInfo.websites != null)
