...
namespace CluedIn.ExternalSearch.Providers.Fullcontact
{
    ...
    public class FullContactEmailExternalSearchProvider : ExternalSearchProviderBase
    {
        /**********************************************************************************************************
         * CONSTRUCTORS
         **********************************************************************************************************/
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FullContactEmailExternalSearchProvider" /> class.
        /// </summary>
        public FullContactEmailExternalSearchProvider()
            : base(Constants.ExternalSearchProviders.FullContactEmailId, EntityType.Person, EntityType.Infrastructure.User, EntityType.Infrastructure.Contact)
        {
        }
        ...
        public override IEnumerable<IExternalSearchQuery> BuildQueries(ExecutionContext context, IExternalSearchRequest request)
        {
            ...
            var emailDomainNames = request.QueryParameters.GetValue(CluedIn.Core.Data.Vocabularies.Vocabularies.CluedInPerson.Email, null);

            if (emailDomainNames != null)
            {
        ...
        public override IEnumerable<IExternalSearchQueryResult> ExecuteSearch(ExecutionContext context, IExternalSearchQuery query)
        {
            ...
            var request = new RestRequest(string.Format("/v2/person.json?email={0}", name), Method.GET);
            ...
            {
                if (response.Data.contactInfo != null && response.Data.contactInfo.fullName != null)
        ...
        public override IEnumerable<Clue> BuildClues(ExecutionContext context, IExternalSearchQuery query, IExternalSearchQueryResult result, IExternalSearchRequest request)
        {
            ...
            if (resultItem.Data.photos != null & resultItem.Data.photos.Any()) this.DownloadPreviewImage(context, resultItem.Data.photos.First().url, clue);
